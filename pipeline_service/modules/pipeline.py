...
class GenerationPipeline:
    ...
    async def prepare_input_images(
        ...
        left_image_edited = self.qwen_edit.edit_image(
            prompt_image=image,
            seed=seed,
            prompt="Show this object in left three-quarters view and make sure it is fully visible in space. Turn background black color contrasting with an object. Persist near object on background. Keep object colors and pose and texture. Sharpen image details.",
        )
        ...
        right_image_edited = self.qwen_edit.edit_image(
            prompt_image=image,
            seed=seed,
            prompt="Show this object in right three-quarters view and make sure it is fully visible in space. Turn background black color contrasting with an object. Persist near object on background. Keep object colors and pose and texture. Sharpen image details.",
        )
        ...
        #     prompt_image=image,
        #     seed=seed,
        #     prompt="Show this object in back three-quarters view and make sure it is fully visible in space. Turn background black color contrasting with an object. Persist near object on background. Keep object colors and pose and texture. Sharpen image details.",
        # )
